...
SPECS = (
    ModelSpec(
        ...
        family="classical",
        description="Causal pre-event bandpower features with logistic regression.",
        adapter_kind="causal_bandpower_logreg",
        train_kind="causal_bandpower_logreg",
        trainable=True,
        realtime_supported=True,
        primary_realtime_allowed=True,
        dependencies=("sklearn", "joblib", "scipy"),
    ...
    ModelSpec(
        ...
        family="classical",
        description="Riemannian covariance tangent-space logistic regression baseline.",
        aliases=("riemann_tangent",),
        adapter_kind="riemann_tangent_logreg",
        train_kind="riemann_tangent_logreg",
        trainable=True,
        realtime_supported=True,
        primary_realtime_allowed=True,
        dependencies=("sklearn", "joblib", "pyriemann"),
