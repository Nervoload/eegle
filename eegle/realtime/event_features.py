...
from eegle.realtime.epoching import MarkerEvent, parse_marker_label
from eegle.recording.legacy_capture import (
    LEGACY_ENGINE_CAPTURE_MAGIC,
    LegacyEngineCaptureWriter,
    read_legacy_engine_capture,
)
...
CAPTURE_MAGIC = LEGACY_ENGINE_CAPTURE_MAGIC
...
EngineInputCaptureWriter = LegacyEngineCaptureWriter


def read_engine_capture(path: str | Path) -> tuple[dict[str, Any], Iterator[tuple[str, Any]]]:
    return read_legacy_engine_capture(path, marker_factory=MarkerEvent)
