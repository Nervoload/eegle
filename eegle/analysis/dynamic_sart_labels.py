...
def compute_support_reference(
    ...
    *,
    ...
    reference = {
        ...
        "support_q95_confidence": "preferred" if len(log_rts) >= 200 else "low",
...
def dynamic_sart_label_contract() -> dict[str, Any]:
    field_names = (
        ...
        "support_relative_slow", "support_relative_slow_confidence", "support_relative_very_slow",
        "support_relative_very_slow_confidence", "commission_error", "omission_error",
        "premature_response", "too_fast_response", "multiple_response", "wrong_key_response",
        "late_response", "behavioral_failure_composite_v1", "previous_valid_go_rt_seconds",
        ...
        "future_behavioral_failure_any_next_5_experimental_trials", "trials_since_behavioral_failure",
...
def _field(description: str, availability: str, eligibility: str, support: bool, future: str | None = None) -> dict[str, Any]:
    return {
        ...
        "confidence_rule": "q80 preferred at 100 valid support go trials; q95 preferred at 200",
