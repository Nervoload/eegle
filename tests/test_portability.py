...
class PortabilityTests(unittest.TestCase):
    def test_neuracle_windows_operator_kit_uses_activation_independent_commands(self) -> None:
        ...
        self.assertIn("$Windowed", dry_run)
        self.assertIn('"--screen-index", [string] $ScreenIndex', dry_run)
        self.assertIn("$useFullScreen = -not $Windowed", dry_run)
        ...
        self.assertFalse(study_config["processes"]["recorder"]["csv_mirror"])
        self.assertTrue(study_config["processes"]["recorder"]["lsl_sample_heartbeat"])
        self.assertEqual(
