...
if ($SkipPractice) {
    ...
    Write-Host "  $PracticeMaxRounds initially planned practice round(s) of $PracticeTrials trials ($PracticeNoGoTrials no-go); after 2 failed rounds choose retry or proceed"
}
