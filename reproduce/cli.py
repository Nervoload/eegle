...
from reproduce.config import DEFAULT_CONFIG, load_config
...
from reproduce.realtime.controller import ClosedLoopController
...
from reproduce.tasks.registry import get_task_spec, list_task_specs
...
def cmd_simulate_eeg(args: argparse.Namespace, config: dict[str, Any]) -> int:
    from reproduce.devices.simulated_lsl import run_simulated_eeg
